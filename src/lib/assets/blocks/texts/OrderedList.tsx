...
export default {
    id: 'ordered-list',
    label: <Trans>Ordered List</Trans>,
    render: (renderProps) => Text.render(renderProps, 'ordered-list-1'),
    export: (renderProps) => Text.export(renderProps, 'ordered-list-1'),
    image:
    ...
    initialValues: {
        'ordered-list-1': merge({}, Text.initialValues, {
            label: `
                <ol>
                    <li>Item 1</li>
                    <li>Item 2</li>
    ...
    settings: [
        {
            id: 'ordered-list-1',
            label: <Trans>Ordered List - 1</Trans>,
            type: 'text',
